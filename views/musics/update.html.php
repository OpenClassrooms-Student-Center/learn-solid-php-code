...
<form class="form-horizontal" action="<?php echo $parameters['submitUrl']; ?>" method="post" enctype="multipart/form-data">
    <div class="controls">
        <label for="file">Fichier:</label>
        <input type="file" id="file" onchange="filesInputHandler(this.files,'title')" name="file" value="<?php echo $parameters['music']->getFile(); ?>">
    </div>
    <div class="controls">
        <label for="title">Titre :</label>
        <input type="text" id="title" name="title" value="<?php echo $parameters['music']->getTitle(); ?>" />
    </div>
    <div class="submit form-actions">
        <input type="hidden" name="id" value="<?php echo $parameters['music']->getId(); ?>" />
